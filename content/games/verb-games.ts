      ...
      rounds: [
        {
          ...
          items: [
            ...
            { prompt: "wir · machen", accept: ["macht"], hint: "macht", audio: true },
            ...
            { prompt: "wir · spielen", accept: ["spielt"], hint: "spielt", audio: true },
            ...
            { prompt: "wir · wohnen", accept: ["wohnt"], hint: "wohnt", audio: true },
            { prompt: "ich · lernen", accept: ["lerne"], hint: "lerne", audio: true },
            { prompt: "du · lernen", accept: ["lernst"], hint: "lernst", audio: true },
            { prompt: "er · lernen", accept: ["lernt"], hint: "lernt", audio: true },
            { prompt: "wir · lernen", accept: ["lernt"], hint: "lernt", audio: true },
            { prompt: "ich · kaufen", accept: ["kaufe"], hint: "kaufe", audio: true },
            { prompt: "du · kaufen", accept: ["kaufst"], hint: "kaufst", audio: true },
            { prompt: "er · kaufen", accept: ["kauft"], hint: "kauft", audio: true },
            { prompt: "wir · kaufen", accept: ["kauft"], hint: "kauft", audio: true },
            { prompt: "ich · arbeiten", accept: ["arbeite"], hint: "arbeite", audio: true },
            { prompt: "du · arbeiten", accept: ["arbeitest"], hint: "arbeitest", audio: true },
            { prompt: "er · arbeiten", accept: ["arbeitet"], hint: "arbeitet", audio: true },
            { prompt: "wir · arbeiten", accept: ["arbeitet"], hint: "arbeitet", audio: true },
            { prompt: "ich · kochen", accept: ["koche"], hint: "koche", audio: true },
            { prompt: "du · kochen", accept: ["kochst"], hint: "kochst", audio: true },
            { prompt: "er · kochen", accept: ["kocht"], hint: "kocht", audio: true },
            { prompt: "wir · kochen", accept: ["kocht"], hint: "kocht", audio: true },
            { prompt: "ich · warten", accept: ["warte"], hint: "warte", audio: true },
            { prompt: "du · warten", accept: ["wartest"], hint: "wartest", audio: true },
            { prompt: "er · warten", accept: ["wartet"], hint: "wartet", audio: true },
            { prompt: "wir · warten", accept: ["wartet"], hint: "wartet", audio: true },
          ],
        },
      ],
    },
      ...
      rounds: [
        {
          ...
          items: [
            ...
            { prompt: "wir · haben", accept: ["haben"], hint: "haben", audio: true },
            { prompt: "ihr · haben", accept: ["habt"], hint: "habt", audio: true },
            { prompt: "sie · haben", accept: ["haben"], hint: "haben", audio: true },
            { prompt: "ich · werden", accept: ["werde"], hint: "werde", audio: true },
            { prompt: "du · werden", accept: ["wirst"], hint: "wirst", audio: true },
            { prompt: "er · werden", accept: ["wird"], hint: "wird", audio: true },
            { prompt: "wir · werden", accept: ["werden"], hint: "werden", audio: true },
            { prompt: "ihr · werden", accept: ["werdet"], hint: "werdet", audio: true },
            { prompt: "sie · werden", accept: ["werden"], hint: "werden", audio: true },
            { prompt: "ich · gehen", accept: ["gehe"], hint: "gehe", audio: true },
            { prompt: "du · gehen", accept: ["gehst"], hint: "gehst", audio: true },
            { prompt: "er · gehen", accept: ["geht"], hint: "geht", audio: true },
            { prompt: "wir · gehen", accept: ["geht"], hint: "geht", audio: true },
            { prompt: "ich · kommen", accept: ["komme"], hint: "komme", audio: true },
            { prompt: "du · kommen", accept: ["kommst"], hint: "kommst", audio: true },
            { prompt: "er · kommen", accept: ["kommt"], hint: "kommt", audio: true },
            { prompt: "wir · kommen", accept: ["kommt"], hint: "kommt", audio: true },
            { prompt: "ich · möchten", accept: ["möchte"], hint: "möchte", audio: true },
            { prompt: "du · möchten", accept: ["möchtest"], hint: "möchtest", audio: true },
            { prompt: "er · möchten", accept: ["möchte"], hint: "möchte", audio: true },
            { prompt: "wir · möchten", accept: ["möchtet"], hint: "möchtet", audio: true },
            { prompt: "ich · können", accept: ["kann"], hint: "kann", audio: true },
            { prompt: "du · können", accept: ["kannst"], hint: "kannst", audio: true },
            { prompt: "er · können", accept: ["kann"], hint: "kann", audio: true },
            { prompt: "wir · können", accept: ["könnt"], hint: "könnt", audio: true },
            { prompt: "ich · müssen", accept: ["muss"], hint: "muss", audio: true },
            { prompt: "du · müssen", accept: ["musst"], hint: "musst", audio: true },
            { prompt: "er · müssen", accept: ["muss"], hint: "muss", audio: true },
            { prompt: "wir · müssen", accept: ["müsst"], hint: "müsst", audio: true },
            { prompt: "ich · wollen", accept: ["will"], hint: "will", audio: true },
            { prompt: "du · wollen", accept: ["willst"], hint: "willst", audio: true },
            { prompt: "er · wollen", accept: ["will"], hint: "will", audio: true },
            { prompt: "wir · wollen", accept: ["wollt"], hint: "wollt", audio: true },
          ],
        },
      ],
    },
