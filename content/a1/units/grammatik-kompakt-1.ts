...
export const wortartenTief: Lesson = {
  ...
  summary:
    "The complete parts of speech system for a total beginner: every word type, how to identify it in a sentence, the differences between them, and an intensive question list.",
  status: "ready",
  sections: [
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          en: "One sentence containing most word types: article, adjective, noun, verb, adverb, preposition, pronoun, conjunction.",
        },
        {
          type: "tip",
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          en: "The nouns der Mann and die Stadt, then the pronouns er and sie that replace them.",
        },
        {
          type: "tip",
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          en: "The verbs arbeiten and kommen, with the adverbs heute, schnell, gern, hierher describing them.",
        },
        {
          type: "tip",
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          en: "schnell and gern as adjective and adverb.",
        },
        {
          type: "tip",
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          en: "Articles (der, die, dem), a preposition (mit, in), and a conjunction (und, weil) working together.",
        },
        {
          type: "tip",
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          en: "Cardinal drei, ordinal erste, interjection Oh.",
        },
        {
          type: "tip",
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          en: "Identify: die (article), kleine (adjective), Katze (noun), schläft (verb), gern (adverb), auf (preposition), dem (article), Sofa (noun), und (conjunction), sie (pronoun), träumt (verb).",
        },
        {
          type: "tip",
  ...
  exercises: [
    ...
    },
    {
      id: "ex-karten",
      type: "flashcard",
      title: "Übung 21: Wortartenkarten",
